...
DeviseTokenAuth.setup do |config|
  ...
  # param is set, the API will redirect to this value when no value is provided by
  # the client.
  config.default_confirm_success_url = Rails.env.production? ? 'https://saudecontrolada.com.br/login' : 'http://localhost:4200/login'
  ...
  config.default_password_reset_url = Rails.env.production? ? 'https://saudecontrolada.com.br/reset-password' : 'http://localhost:4200/reset-password'
